...
class ModelTrainer:
    ...
    def initiate_model_trainer(self, train_array, test_array):
        try:
            ...
            #to gest best model from our report dictionary
            ...
            print(f"best model found:{best_model_name},Accuracy_score:{best_model_score}")
            print("\n*********\n")
            logging.info(f"best model found:{best_model_name},accuracy_score:{best_model_score}")
            
            save_object(file_path=self.model_trainer_config.train_model_file_path,obj=best_model)  

        except Exception as e:
            raise CustomException(e,sys) #e = error , sys= error details