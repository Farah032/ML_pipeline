#create prediction pipeline file
#craete function for load a object(pickle and preprocessor)
#create custom class based on dataset
#create function to convert data into dataframe with help of dictionary
